...
let isEmpty = Object.entries(emptyObject).length === 0
...
let planet = solarSystem.properties.planets
let argonOnEarthLikeMars = planet[2].atmosphere.argon === planet[3].atmosphere.argon
